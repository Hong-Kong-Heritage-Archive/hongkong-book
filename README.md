...
所有內容存放於 `knowledge/` 之下，分為五種實體類型：

- **`knowledge/books/`** — 主要目錄。每本書一個檔案：書目資料、原創摘要，以及策展式的「為何重要」分析。絕不收錄書籍本身的文字內容。
- **`knowledge/people/`** — 真實人物頁面：作者、評論者、被討論人物等，當同一人物在 2 本以上書中出現時，才升級為正式個人條目。
- **`knowledge/memes/`** — 跨書籍反覆出現的概念與文化母題（例如獅子山精神），與所有涉及該概念的書籍互相連結。
- **`knowledge/resources/`** — 可實際取得實體書的圖書館、借閱平台、書店等資源頁面。純文字佔位符先行，達到 2 本以上書籍引用才升級。
