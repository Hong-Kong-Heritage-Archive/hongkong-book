...
| `ghostly-realism` (靈異寫實) | 偵探冰室．靈 ↔ 崩堤之夏 ↔ 胭脂扣 (NOT 武道狂之詩) | User proposed 武道狂之詩 as a candidate; checked it against the meme's actual mechanism (supernatural/unreal device standing in for trauma) and it doesn't fit — no ghosts, no unreal elements, just direct combat. Said so explicitly in the meme rather than force the connection. 胭脂扣 was proposed as an alternative, verified, and added |
